...
module "secretsmanager_secret" {
  ...
  name   = "example-secretsmanager-secret"
  tags = {
    Environment = "dev"
    Owner       = "platform"
    ManagedBy   = "terraform"

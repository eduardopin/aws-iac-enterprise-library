...
module "glue_catalog_database" {
  ...
  name   = "example-glue-catalog-database"
  tags = {
    Environment = "dev"
    Owner       = "platform"
    ManagedBy   = "terraform"
